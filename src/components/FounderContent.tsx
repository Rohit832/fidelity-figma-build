...
export const FounderContent: React.FC = () => {
  ...
  return (
    <div className="flex w-[521px] flex-col items-start gap-[43px] relative max-md:w-full max-md:max-w-[600px] max-sm:gap-[30px]">
      ...
      <div className="flex items-center gap-[35px] relative max-md:justify-center max-md:gap-[25px] max-sm:flex-col max-sm:gap-5 max-sm:items-center">
        <button
          onClick={handleMeetRishita}
          className="flex w-[331px] h-[63px] flex-col justify-center items-center gap-[8.283px] relative cursor-pointer px-[14.909px] py-[6.626px] rounded-[41.413px] max-sm:w-[280px] max-sm:h-[55px] bg-gradient-to-r from-[rgba(53,115,105,1)] to-[rgba(46,114,101,1)] hover:from-[rgba(53,115,105,0.9)] hover:to-[rgba(46,114,101,0.9)] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[rgba(53,115,105,0.5)] focus:ring-offset-2"
          aria-label="Request a demo to meet Rishita"
        >
          <div className="flex h-[27px] items-center gap-[12.424px] shrink-0 relative">
            <div className="flex w-[265px] h-8 flex-col justify-center text-center relative">
